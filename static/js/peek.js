...
$(document).ready(function () {
	$('body').get(0).innerHTML+=
		"<div id='peek'>"+
			...
			"<div id='buttonbar'>"+
			  "<input id='send_button' type='button' value='Send Data' disabled='disabled' class='button'>"+
			  "<input id='clear_console' type='button' value='Clear console' disabled='enabled' class='button'>"+
			"</div>"+
		"</div>";
